...
# #
def __exec_command(command_lib, arguments):
    ...
    env_yaml_file_path = os.environ.get("ENV_YAML_FILE_PATH"),
    ...
    # Versions
    executor.set_api_version("v6")
    executor.set_ad_manager_api_version("v202111")
    ...
    executor.set_env_variables(
        ...
        yaml_file_path = env_yaml_file_path,
        logging = env_logging
    )
...
##
def __try_exec_command(command_lib, arguments):
    try:
        return __exec_command(command_lib, arguments)
...
def __main():
    ...
    if not os.path.exists(command_path):
        ...
        result = __try_exec_command(command_lib, arguments)
